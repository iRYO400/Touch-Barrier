package workshop.akbolatss.standout.constants;

import workshop.akbolatss.standout.StandOutWindow;
import workshop.akbolatss.standout.ui.Window;
...
public class StandOutFlags {
     ...
     * {@link StandOutWindow#getHiddenNotificationTitle(int)}, and
     * {@link StandOutWindow#getHiddenNotificationMessage(int)} are implemented, and that
     ...
     * keys.
     *
     * @see StandOutWindow#focus(int)
     * @see StandOutWindow#unfocus(int)
     */
     ...
     * implementation.
     *
     * @see Window#fixCompatibility(View)
     */
     ...
     * implementation.
     *
     * @see Window#addFunctionality(View)
     */
