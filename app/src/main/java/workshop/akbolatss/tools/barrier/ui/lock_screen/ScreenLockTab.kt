...
import workshop.akbolatss.tools.barrier.ui.lock_screen.pin.PinLockFragment
...
enum class ScreenLockTab(val fragmentTag: String?, val navigationTabFactory: NavigationTabFactory) {
    PIN(PinLockFragment::class.java.canonicalName,
            object : NavigationTabFactory {
                override fun newInstance(): Fragment {
                    return PinLockFragment.newInstance()
                }
            }),
